...
/*
@Configuration: Spring procura metodos que podem criar instancias de componentes que vc tenha interesse que sejam criados
@Bean: Spring sabe que esse é um metodo canditado a ser procurado na hora de fazer a resolução
@Value: Se definir o valor padrão como está vindo no metodo (...maxSize:20) nao precisamos necessariamente definir no yml
*/
